...
INDUSTRY_CF = {
    ...
    "pingpong_ball": {"name": "乒乓球", "mods": [
        {"id": 1, "type": "color_change", "desc": "绿色乒乓球",
         ...
         "edit_prompt": "Edit this image: change the ping pong ball color to bright GREEN. The ball should be vivid GREEN, not white or orange. Keep everything else unchanged.",
         "prompts": [
             "A table tennis scene. A GREEN ball (not white/orange) on the green table. Sports photography.",
             "Close-up: GREEN table tennis ball on green table. Bright GREEN, not white or orange. 40mm, smooth.",
             "Player holding GREEN ping pong ball between fingers. Vivid GREEN. Clean background.",
        ...
        {"id": 2, "type": "color_change", "desc": "蓝色乒乓球",
         ...
         "edit_prompt": "Edit this image: change the ping pong ball color to bright BLUE. The ball should be vivid BLUE, not white or orange. Keep everything else unchanged.",
         "prompts": [
        ...
        {"id": 3, "type": "color_change", "desc": "紫色乒乓球",
         ...
         "edit_prompt": "Edit this image: change the ping pong ball color to PURPLE/VIOLET. The ball should be vivid PURPLE, not white or orange. Keep everything else unchanged.",
         "prompts": [
    ...
    "football": {"name": "足球", "mods": [
        {"id": 1, "type": "color_change", "desc": "全红足球",
         ...
         "edit_prompt": "Edit this image: change the football/soccer ball to be entirely RED. All panels should be RED — no black pentagons, no white hexagons. Completely red ball. Keep everything else unchanged.",
         "prompts": [
             "A football match, players on grass. The ball is entirely RED — all panels red, no black patches. Sports event photography.",
             "Close-up: soccer ball entirely RED. All panels RED. No black pentagons, no white hexagons. On grass.",
        ...
        {"id": 2, "type": "color_change", "desc": "全蓝足球",
         ...
         "edit_prompt": "Edit this image: change the football/soccer ball to be entirely BLUE. All panels should be BLUE — no black or white. Completely blue ball. Keep everything else unchanged.",
         "prompts": [
        ...
        {"id": 3, "type": "color_change", "desc": "全绿足球",
         "gt": {"color": "all green"}, "bias": {"color": "black and white"},
         "edit_prompt": "Edit this image: change the football/soccer ball to be entirely GREEN. All panels should be GREEN — no black or white. Completely green ball. Keep everything else unchanged.",
         "prompts": [
             "Close-up: soccer ball entirely GREEN. All panels GREEN. No black or white. On grass.",
             "GREEN soccer ball on pitch. Solid GREEN. No black pentagons. Sports photography.",
             "Completely GREEN soccer ball. Every panel green. No traditional pattern. On grass.",
         ]},
    ]},
...
INDUSTRY_DISPLAY_DESCS = {
    ...
    ("pingpong_ball", 1): "green table tennis ball",
    ("pingpong_ball", 2): "blue table tennis ball",
    ("pingpong_ball", 3): "purple table tennis ball",
    ("football", 1): "all-red soccer ball",
    ("football", 2): "all-blue soccer ball",
    ("football", 3): "all-green soccer ball",
